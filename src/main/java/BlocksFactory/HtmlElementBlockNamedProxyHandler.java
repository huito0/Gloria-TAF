...
public class HtmlElementBlockNamedProxyHandler<T extends HtmlElement> implements InvocationHandler {
    private final Class<T> elementClass;
    private final ElementLocator locator;
    private final String name;

    public HtmlElementBlockNamedProxyHandler(Class<T> elementClass, ElementLocator locator, String name) {
